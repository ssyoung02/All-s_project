...
public class SecurityConfig extends WebSecurityConfigurerAdapter  {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        // 그 외 모든 요청은 인증된 사용자만 접근 허용
                ...
                .ignoringAntMatchers("/Users/checkDuplicate", "/Users/updateLocation", "/include/start", "/include/pause", "/include/updateTime", "/include/updateMemo", "/calendar/**","/Users/UsersImageUpdate","/studies/nearestStudies")
                .and()
